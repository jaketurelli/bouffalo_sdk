...
size_t MockMicroGraph::NumSubgraphInputs(int subgraph_idx)
{
    return 1;
}
...
size_t MockMicroGraph::NumSubgraphOutputs(int subgraph_idx)
{
    return 1;
}
...
int MockMicroGraph::NumSubgraphs()
{
    return kMaxSubgraphs;
}
