...
TfLiteStatus EqualEval(TfLiteContext *context, TfLiteNode *node)
{
    ...
    switch (input1->type) {
        case kTfLiteBool:
            requires_broadcast ? reference_ops::Broadcast4DSlowEqualNoScaling(
        ...
        case kTfLiteInt64:
            ...
            break;
        case kTfLiteUInt8:
            requires_broadcast ? reference_ops::Broadcast4DSlowEqualWithScaling(
                                     data->params, input1_shape,
...
TfLiteStatus NotEqualEval(TfLiteContext *context, TfLiteNode *node)
{
    ...
    switch (input1->type) {
        case kTfLiteBool:
            requires_broadcast ? reference_ops::Broadcast4DSlowNotEqualNoScaling(
                                     data->params, input1_shape,
                                     tflite::micro::GetTensorData<bool>(input1), input2_shape,
                                     tflite::micro::GetTensorData<bool>(input2), output_shape,
                                     output_data) :
        ...
        case kTfLiteInt64:
            ...
            break;
        case kTfLiteUInt8:
            requires_broadcast ? reference_ops::Broadcast4DSlowNotEqualWithScaling(
                                     data->params, input1_shape,
                                     tflite::micro::GetTensorData<uint8_t>(input1), input2_shape,
                                     tflite::micro::GetTensorData<uint8_t>(input2), output_shape,
                                     output_data) :
...
TfLiteStatus GreaterEval(TfLiteContext *context, TfLiteNode *node)
{
    ...
    switch (input1->type) {
        case kTfLiteFloat32:
            requires_broadcast ? reference_ops::Broadcast4DSlowGreaterNoScaling(
                                     data->params, input1_shape,
                                     tflite::micro::GetTensorData<float>(input1), input2_shape,
                                     tflite::micro::GetTensorData<float>(input2), output_shape,
                                     output_data) :
...
TfLiteStatus GreaterEqualEval(TfLiteContext *context, TfLiteNode *node)
{
    ...
    switch (input1->type) {
        case kTfLiteFloat32:
            requires_broadcast ? reference_ops::Broadcast4DSlowGreaterEqualNoScaling(
                                     data->params, input1_shape,
                                     tflite::micro::GetTensorData<float>(input1), input2_shape,
                                     tflite::micro::GetTensorData<float>(input2), output_shape,
                                     output_data) :
        ...
        case kTfLiteInt64:
            ...
            break;
        case kTfLiteUInt8:
            requires_broadcast ? reference_ops::Broadcast4DSlowGreaterEqualWithScaling(
                                     data->params, input1_shape,
                                     tflite::micro::GetTensorData<uint8_t>(input1), input2_shape,
                                     tflite::micro::GetTensorData<uint8_t>(input2), output_shape,
                                     output_data) :
...
TfLiteStatus LessEval(TfLiteContext *context, TfLiteNode *node)
{
    ...
    switch (input1->type) {
        case kTfLiteFloat32:
            requires_broadcast ? reference_ops::Broadcast4DSlowLessNoScaling(
                                     data->params, input1_shape,
                                     tflite::micro::GetTensorData<float>(input1), input2_shape,
                                     tflite::micro::GetTensorData<float>(input2), output_shape,
                                     output_data) :
        ...
        case kTfLiteInt64:
            ...
            break;
        case kTfLiteUInt8:
            requires_broadcast ? reference_ops::Broadcast4DSlowLessWithScaling(
                                     data->params, input1_shape,
                                     tflite::micro::GetTensorData<uint8_t>(input1), input2_shape,
                                     tflite::micro::GetTensorData<uint8_t>(input2), output_shape,
                                     output_data) :
...
TfLiteStatus LessEqualEval(TfLiteContext *context, TfLiteNode *node)
{
    ...
    switch (input1->type) {
        case kTfLiteFloat32:
            requires_broadcast ? reference_ops::Broadcast4DSlowLessEqualNoScaling(
                                     data->params, input1_shape,
                                     tflite::micro::GetTensorData<float>(input1), input2_shape,
                                     tflite::micro::GetTensorData<float>(input2), output_shape,
                                     output_data) :
        ...
        case kTfLiteInt64:
            ...
            break;
        case kTfLiteUInt8:
            requires_broadcast ? reference_ops::Broadcast4DSlowLessEqualWithScaling(
                                     data->params, input1_shape,
                                     tflite::micro::GetTensorData<uint8_t>(input1), input2_shape,
                                     tflite::micro::GetTensorData<uint8_t>(input2), output_shape,
                                     output_data) :
