...
static void copy_cell_txt(lv_table_cell_t * dst, const char * txt, uint32_t dst_len);
...
void lv_table_set_cell_value(lv_obj_t * obj, uint16_t row, uint16_t col, const char * txt)
{
    ...
    copy_cell_txt(table->cell_data[cell], txt, to_allocate);
