...
#define Sec_Eng_PKA_MSUB(dt, di, s0t, s0i, s1t, s1i, s2t, s2i, lastop) bflb_pka_msub(bignum_pka, s0i, s0t, di, dt, s1i, s1t, s2i, s2t, lastop)
#define Sec_Eng_PKA_MMUL(dt, di, s0t, s0i, s1t, s1i, s2t, s2i, lastop) bflb_pka_mmul(bignum_pka, s0i, s0t, di, dt, s1i, s1t, s2i, s2t, lastop)
// #define Sec_Eng_PKA_LCMP()
#define Sec_Eng_PKA_Write_Data(dt, di, data, len, lastop) bflb_pka_write(bignum_pka, di, dt, data, len, lastop)
#define Sec_Eng_PKA_Read_Data(dt, di, data, len) bflb_pka_read(bignum_pka, di, dt, data, len)
#define Sec_Eng_PKA_Move_Data(dt, di, s0t, s0i, lastop) bflb_pka_movdat(bignum_pka, s0i, s0t, di, dt, lastop)
#define Sec_Eng_PKA_MREM(dt, di, s0t, s0i, s2t, s2i, lastop) bflb_pka_mrem(bignum_pka, s0i, s0t, di, dt, s2i, s2t, lastop)
#define Sec_Eng_PKA_MINV(dt, di, s0t, s0i, s2t, s2i, lastop) bflb_pka_minv(bignum_pka, s0i, s0t, di, dt, s2i, s2t, lastop)
#define Sec_Eng_PKA_MSQR(dt, di, s0t, s0i, s2t, s2i, lastop) bflb_pka_msqr(bignum_pka, s0i, s0t, di, dt, s2i, s2t, lastop)
#define Sec_Eng_PKA_CREG(dt, di, size, lastop) bflb_pka_clir(bignum_pka, di, dt, size, lastop)
#define Sec_Eng_PKA_Write_Immediate(dt, di, data, lastop) bflb_pka_slir(bignum_pka, di, dt, data, lastop)
#define Sec_Eng_PKA_LMUL2N(dt, di, s0t, s0i, bitshift, lastop) bflb_pka_lmul2n(bignum_pka, s0i, s0t, di, dt, bitshift, lastop)
#define Sec_Eng_PKA_Reset() bignum_pka = bflb_device_get_by_name("pka"); bflb_pka_init(bignum_pka)
#define Sec_Eng_PKA_BigEndian_Enable()
#define Sec_Eng_PKA_GF2Mont(dt, di, st, si, size, tt, ti, pt, pi) bflb_pka_gf2mont(bignum_pka, si, st, di, dt, ti, tt, pi, pt ,size)
#define Sec_Eng_PKA_MEXP(dt, di, s0t, s0i, s1t, s1i, s2t, s2i, lastop) bflb_pka_mexp(bignum_pka, s0i, s0t, di, dt, s1i, s1t, s2i, s2t, lastop)
