...
#ifndef  __BL606P_PLATFORM_H__
#define  __BL606P_PLATFORM_H__
...
#define DMA0_ALL_IRQn          (IRQ_NUM_BASE + 15)   // DMA0_INTR_ALL Interrupt
#define DMA1_ALL_IRQn          (IRQ_NUM_BASE + 16)   // DMA1_INTR_ALL Interrupt
