...
__attribute__((section(".fw_header"))) struct bootheader_t fw_header = {
    ...
    .clk_cfg.cfg.pll_clk = 0x05,   /*!< mcu_clk #0:RC32M, 1:XTAL, 2:DLL 26.6M, 3:DLL 42.67M, 4:DLL 64M, 5:DLL 128M */
    .clk_cfg.cfg.hclk_div = 0x00,
    .clk_cfg.cfg.bclk_div = 0x01,
    .clk_cfg.cfg.flash_clk_type = 0x00, /*!< #0:XCLK(RC32M or XTAL), 1:64M, 2:BCLK, 3:42.67M */
