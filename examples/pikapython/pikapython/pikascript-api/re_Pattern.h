...
PikaObj* re_Pattern_split(PikaObj *self, char* subject, PikaTuple* maxsplit__flags);
char* re_Pattern_sub(PikaObj *self, char* repl, char* subjet, PikaTuple* count__flags);
PikaObj* re_Pattern_subn(PikaObj *self, char* repl, char* subjet, PikaTuple* count__flags);
